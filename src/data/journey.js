...
const journey = [
  {
    ...
    highlight: true,
    items: [
      "Technical Product Management — Systems & Delivery (Independent) across MedTech and regulated B2B contexts",
      "Built and shipped product systems around roles, states, data integrity, and decision-support workflows",
      "Used prototyping to de-risk architecture decisions and improve execution alignment",
    ],
  },
  {
    year: "2024-2025",
  ...
  },
  {
    ...
    icon: "Brain",
    items: [
      "Founded LiveSurgery concept and built early PoC for surgical collaboration workflows",
      "Defined MVP scope, user flows, and feasibility assumptions for multi-source session orchestration",
      "Selected for accelerator support with early mentor validation",
    ],
  },
  {
    year: "2020",
  ...
  },
  {
    ...
    icon: "PenTool",
    items: [
      "Completed GoUX UX Design Course (Kyiv) with focus on usability and workflow clarity",
      "Applied UX thinking to product discovery, stakeholder alignment, and adoption quality",
    ],
  },
  {
    year: "2011-2012",
