...
export default {
  ...
  site: {
    ...
    seo: {
      homeTitle: "Roman Mazuryk - MedTech Product & Workflow Systems",
      homeDescription: "MedTech operator and product systems builder combining real implementation experience with AI-assisted discovery, prototyping, documentation, and delivery.",
