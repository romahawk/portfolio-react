...
import { Layers, Target, Users, Dot, ArrowRight } from "lucide-react";
      ...
      <div className="about__container">
        <div className="about__row about__row--two-columns reveal reveal--delay-1">
          ...
          <div className="about__panel">
            ...
            <p className="about__text">
              ...
              predictable under real constraints.
            </p>
          </div>
        </div>
        ...
        <div className="about__row reveal">
          ...
          <a href="#ai-sdlc" className="btn btn--primary about__framework-cta">
            View My AI-Leverage Framework <ArrowRight size={16} className="icon ml-1" />
          </a>
        </div>
        ...
        <div className="about__row reveal">
          ...
          <p className="about__text">
            ...
            the trade-offs that drive speed, reliability, and long-term leverage.
          </p>
          <p className="about__text">
            This is systems ownership end-to-end: from ambiguity to shipped operational impact.
          </p>
        </div>
        ...
        <div className="about__row reveal">
          ...
          <blockquote className="about__quote">
            <em>
              "Senior product leadership is trade-off management under constraint. Systems win when
              those trade-offs stay explicit."
            </em>
          </blockquote>
        </div>
      </div>
